    ...
    public partial class db : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IdTipoDeEvento = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Titulo = table.Column<string>(type: "varchar(100)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_TipoEvento", x => x.IdTipoDeEvento);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Evento_TipoEvento_IdTipoDeEvento",
                        column: x => x.IdTipoDeEvento,
                        principalTable: "TipoEvento",
                        principalColumn: "IdTipoDeEvento",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Usuario_TipoEvento_IdTipoUsuario",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Evento_IdTipoDeEvento",
                table: "Evento",
                column: "IdTipoDeEvento");
